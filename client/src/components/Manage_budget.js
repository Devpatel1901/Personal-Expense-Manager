        ...
        return (
            ...
            <div className="container" style={{fontFamily: "'Cormorant Garamond', serif",marginTop: "8vh"}}>
                ...
                <div className="my-5">
                    ...
                    <table class="table table-hover" style={{border: "0.7px solid #ff7818"}}>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <td>12000</td>
                            <td>
                                <button className="btn btn-primary" style={{marginRight: "10px"}} data-toggle="tooltip" data-placement="bottom" title="Edit Budget Record">
                                ...
                                |
                                <button className="btn btn-primary" style={{marginLeft: "10px"}} data-toggle="tooltip" data-placement="bottom" title="Delete Budget Record">
